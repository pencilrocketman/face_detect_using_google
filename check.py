...
#image=cv2.imread("./origin_image/00.9.jpg")
#image=cv2.imread("./origin_image/01.14.jpg")
#image=cv2.imread("./origin_image/02.14.jpg")
#image=cv2.imread("./origin_image/03.0.jpg")
#image=cv2.imread("./origin_image/04.2.jpg")
image=cv2.imread("./origin_image/idota.jpg")
if image is None:
    print("Not open:")
